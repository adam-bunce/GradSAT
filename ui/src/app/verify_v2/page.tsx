...
export default function Page() {
  ...
  const validateGraduation = async () => {
    ...
    try {
      ...
      if (res.courses.length == 0) {
        ...
        toast({
          title: "Graduations requirements met",
          description: ``,
          variant: "default",
        });
      }
  ...
  const handleFileSubmission = async () => {
    ...
    try {
      ...
      console.log("p_pdf_resp", processPdfResponse);
  ...
  return (
    <div className={"space-y-3 lg:-mx-12"}>
      ...
      {/*<div>*/}
      {/*  {userCourseInput.map((thing, idx) => (*/}
      {/*    <div key={idx}>{thing.course_name}</div>*/}
      {/*  ))}*/}
      {/*</div>*/}
