...
# could probably just do [list of all courses that are treated as the same course] with model.add(sum([vars] <= 0))
# if there perf issues it makes sense to reduce the # of constraints, fine for rn though i think
credit_restrictions: dict[str, list[str]] = {
    "CSCI1030U": ["BUSI1830U", "CSCI1020U", "CSCI1600U"],
